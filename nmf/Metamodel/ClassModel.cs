...
namespace TTC2016.ArchitectureCRA.ArchitectureCRA
{
    ...
    public class ClassModel : NamedElement, IClassModel, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://momot.big.tuwien.ac.at/architectureCRA/1.0#//ClassModel/");
            }
        }
        
        /// <summary>
        /// Forwards change notifications for the Classes property to the parent model element
        /// </summary>
        ...
        /// <summary>
        /// Forwards change notifications for the Features property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        ...
        {
            return ((NMF.Models.Meta.IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://momot.big.tuwien.ac.at/architectureCRA/1.0#//ClassModel/")));
        }
