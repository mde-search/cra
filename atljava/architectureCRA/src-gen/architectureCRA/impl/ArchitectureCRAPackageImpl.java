...
public class ArchitectureCRAPackageImpl extends EPackageImpl implements ArchitectureCRAPackage {
	 ...
	 * @see architectureCRA.ArchitectureCRAPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ArchitectureCRAPackage init() {
		if (isInited)
			return (ArchitectureCRAPackage) EPackage.Registry.INSTANCE.getEPackage(ArchitectureCRAPackage.eNS_URI);

		// Obtain or create and register package
		ArchitectureCRAPackageImpl theArchitectureCRAPackage = (ArchitectureCRAPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof ArchitectureCRAPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
	...
	public void initializePackageContents() {
		...
		initEClass(classEClass, architectureCRA.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_Encapsulates(), this.getFeature(), this.getFeature_IsEncapsulatedBy(), "encapsulates",
				null, 1, -1, architectureCRA.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
		...
		initEReference(getMethod_DataDependency(), this.getAttribute(), null, "dataDependency", null, 0, -1,
		...
		initEReference(getFeature_IsEncapsulatedBy(), this.getClass_(), this.getClass_Encapsulates(),
				"isEncapsulatedBy", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
