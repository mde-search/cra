...
public abstract class FeatureImpl extends NamedElementImpl implements Feature {
			...
			if (isEncapsulatedBy != oldIsEncapsulatedBy) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ArchitectureCRAPackage.FEATURE__IS_ENCAPSULATED_BY, oldIsEncapsulatedBy, isEncapsulatedBy));
			}
		}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIsEncapsulatedBy(architectureCRA.Class newIsEncapsulatedBy,
			NotificationChain msgs) {
		architectureCRA.Class oldIsEncapsulatedBy = isEncapsulatedBy;
		isEncapsulatedBy = newIsEncapsulatedBy;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ArchitectureCRAPackage.FEATURE__IS_ENCAPSULATED_BY, oldIsEncapsulatedBy, newIsEncapsulatedBy);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setIsEncapsulatedBy(architectureCRA.Class newIsEncapsulatedBy) {
		if (newIsEncapsulatedBy != isEncapsulatedBy) {
			...
			if (isEncapsulatedBy != null)
				msgs = ((InternalEObject) isEncapsulatedBy).eInverseRemove(this,
						ArchitectureCRAPackage.CLASS__ENCAPSULATES, architectureCRA.Class.class, msgs);
			if (newIsEncapsulatedBy != null)
				msgs = ((InternalEObject) newIsEncapsulatedBy).eInverseAdd(this,
						ArchitectureCRAPackage.CLASS__ENCAPSULATES, architectureCRA.Class.class, msgs);
			msgs = basicSetIsEncapsulatedBy(newIsEncapsulatedBy, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitectureCRAPackage.FEATURE__IS_ENCAPSULATED_BY,
