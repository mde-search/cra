 ...
 * </p>
 * <ul>
 *   <li>{@link architectureCRA.impl.ClassImpl#getEncapsulates <em>Encapsulates</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassImpl extends NamedElementImpl implements architectureCRA.Class {
	/**
	...
	public EList<Feature> getEncapsulates() {
		if (encapsulates == null) {
			encapsulates = new EObjectWithInverseResolvingEList<Feature>(Feature.class, this,
					ArchitectureCRAPackage.CLASS__ENCAPSULATES, ArchitectureCRAPackage.FEATURE__IS_ENCAPSULATED_BY);
		}
		return encapsulates;
	}
