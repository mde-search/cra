...
import at.ac.tuwien.big.momot.examples.modularization.ttc.architecture.ArchitectureCRAFactory;
...
public class ArchitectureCRAPackageImpl extends EPackageImpl implements ArchitectureCRAPackage
{
	 ...
	 * @see at.ac.tuwien.big.momot.examples.modularization.ttc.architecture.ArchitectureCRAPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ArchitectureCRAPackage init()
	{
		...
		ArchitectureCRAPackageImpl theArchitectureCRAPackage = (ArchitectureCRAPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ArchitectureCRAPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ArchitectureCRAPackageImpl());
	...
	public void initializePackageContents()
	{
		...
		initEClass(classEClass, at.ac.tuwien.big.momot.examples.modularization.ttc.architecture.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_Encapsulates(), this.getFeature(), this.getFeature_IsEncapsulatedBy(), "encapsulates", null, 1, -1, at.ac.tuwien.big.momot.examples.modularization.ttc.architecture.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
